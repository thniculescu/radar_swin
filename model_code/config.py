...
_C.DATA.DATA_PATH = ''
# Dataset name
_C.DATA.DATASET = 'nuscenes'
# Input image size
_C.DATA.INPUT_SIZE = (6, 360)
...
_C.MODEL.RADARSWIN.IN_CHANS = 3
_C.MODEL.RADARSWIN.OUT_REG_HEADS = [1, 1, 4, 2] #r | center_off | sin_or, cos_or, bb_w, bb_l | vr, vt
_C.MODEL.RADARSWIN.EMBED_DIM = 6
_C.MODEL.RADARSWIN.DEPTHS = [2, 2, 6, 2]
_C.MODEL.RADARSWIN.NUM_HEADS = [1, 3, 3, 12]
_C.MODEL.RADARSWIN.WINDOW_SIZES = [(6, 6), (6, 6), (3, 6), (1, 5)]
_C.MODEL.RADARSWIN.MERGE_FACTORS = [(1, 2), (2, 2), (3, 2), (1, 1)]
_C.MODEL.RADARSWIN.REDUCTION_FACTORS = [1, 2, 2, 1]
_C.MODEL.RADARSWIN.MLP_RATIO = 4.
_C.MODEL.RADARSWIN.QKV_BIAS = True
_C.MODEL.RADARSWIN.QK_SCALE = None
_C.MODEL.RADARSWIN.TEMPORAL_ATTENTION = True
_C.MODEL.RADARSWIN.APE = False
_C.MODEL.RADARSWIN.PATCH_NORM = True

_C.MODEL.RADARSWIN.RANGE_LOSS_WEIGHT = 1.0
_C.MODEL.RADARSWIN.BBOX_LOSS_WEIGHT = 1.0
_C.MODEL.RADARSWIN.VELOCITY_LOSS_WEIGHT = 1.0
...
# -----------------------------------------------------------------------------
_C.CENTERNET = CN()
_C.CENTERNET.PRED_HEATMAP_THR = 0.25
...
# -----------------------------------------------------------------------------
_C.METRICS = CN()
_C.METRICS.AP_THR = [0.5, 1.0, 2.0, 4.0]
